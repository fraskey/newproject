	...
	for(SymPos = 0; SymPos < symbolNum;SymPos++)
	{
		...
		if(allordernumbers>2)
		{
			if(ordersrealprofitallbyforex(SymPos)>
				(ordersexpectedmaxprofitallbyforex(SymPos)*100/(4*allordernumbers*allordernumbers*allordernumbers+2*allordernumbers*allordernumbers+20*allordernumbers+100)))
			{
